...
class ConfigTest {
    ...
    void findAllClassesTest(){
        ...
        ['jaemisseo.man', 'install'].each{ packageName ->
            List<Class> jobList = Config.findAllClasses(packageName, [Job, Employee])
            List<Class> taskList = Config.findAllClasses(packageName, [Task])
            List<Class> dataList = Config.findAllClasses(packageName, [Data])
            List<Class> beanList = Config.findAllClasses(packageName, [Bean])
        }
