package com.jaemisseo.hoya.util.encryptor.crypto
...
//            return java.util.Base64.encodeBase64String(bytes);
...
//            byte[] bytes = java.util.Base64.decodeBase64(cipherText);
            Cipher cipher = Cipher.getInstance(KEY_FACTORY_ALGORITHM);
...
//            return java.util.Base64.encodeBase64String(signature);
...
//            if (!sig.verify(java.util.Base64.decodeBase64(signature)))
                throw new RSAGreatMan.InvalidSignatureException("It was awesome! Signature hasn't be invalid");
